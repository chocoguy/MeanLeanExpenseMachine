...
SubMenu::SubMenu(const wxString& title) : wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(280, 180))
{
	...
	imp = new wxMenu;
	imp->Append(wxID_ANY, wxT("Import newsfeed..."));
	imp->Append(wxID_ANY, wxT("Import bookmarks..."));
	imp->Append(wxID_ANY, wxT("Import Anime..."));
